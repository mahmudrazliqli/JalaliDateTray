...
CFLAGS   += -Wall -Wextra $(shell pkg-config --cflags gtk+-3.0 libconfig)
LDLIBS   := $(shell pkg-config --libs gtk+-3.0 libconfig)
...
# ---------------------------------------------------------------------
# Build a .deb package: make deb -> JalaliDate_<version>_<arch>.deb
